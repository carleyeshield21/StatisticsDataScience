...
# list = list.split(' ')
# num_list = [numpy.int64(item) for item in list]
...
# a = '10 12 5 8 13 10 12 8 7 11 11 10 4 11 12 7 9 10 9 9 11 15 12 17 14 10 9 8 15 16 10 14 7 16 9 1 3 11 14 8 12 5 10 9 7 11 14 10 15 9'
a = '10 12 5 8 13 10 12 8 7 11 11 10 4 11 12 7 9 10 9 9 11 15 12 17 14 10 9 8 15 16 10 147 16 9 1 3 11 14 8 12 5 10 9 7 11 14 10 15 9'
a_list = a.split(' ')
